...
class game:
	...
	def game_mv(self,arr):
		...
		get_fig = input("Select %s figure " % self.fig_color).lower()
		

		while len(get_fig) != 2 or not get_fig[1].isdigit() or not get_fig[0].isalpha():
			get_fig = input("Select correct index %s figure " % self.fig_color).lower()
		...
		while check or 0 > get1 or get1 > 7 or 1 > get2 or get2 > 8 :
...
########### set ########################################################
		...
		while len(set_fig) != 2 or not set_fig[1].isdigit() or not set_fig[0].isalpha():
		...
		while check or 0 > set1 or set1 > 7 or 1 > set2 or set2 > 8 or len(set_fig) != 2:
