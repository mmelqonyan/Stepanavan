...
def hor_variant(i, j, simvol):
    ...
    #if (board[i-2][(j-1 or j+1)] or board[i+2][(j-1 or j+1)] == horse ) or (board[i+1][(j-2 or j+2 )] or board[i-1][(j-2 or j+2)] == horse):
...
def game(get1,get2):
    ...
    hor_variant(get1 - 1, get2 - 1, "\033[93m{}\033[00m" .format('| *'))
...
def game_mv(get1, get2):
    ...
    que_variant(get1-1, get2-1,"\033[91m{}\033[00m".format('| +'))
    tesq()
